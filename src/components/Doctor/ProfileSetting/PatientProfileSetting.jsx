                            ...
                            <form className="row form-row" onSubmit={handleSubmit(onSubmit)}>
                                ...
                                <div className="col-md-6">
                                    <div className="form-group mb-2">
                                        <label>Gender</label>
                                        <select className="form-control select text-capitalize" onChange={handleChange} name='gender' value={selectGender}>
                                            {
                                                genderOptions.map((x, index) => (
                                                    <option key={index} className='text-capitalize' value={x.value} >{x.label}</option>
                                                ))
                                            }
                                        </select>
                                    </div>
