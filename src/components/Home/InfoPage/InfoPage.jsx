                ...
                <div className="row">
                    <div className="col-lg-4 d-flex align-items-stretch">
                        <div className="content">
                            <h3>Why Choose Us?</h3>
                            <p>
                                Doctor's care is committed to excellence in health care. Our providers work together to provide comprehensive, personalized care to all people.
                            </p>
                            ...
                            <div className="row">
                                ...
                                <div className="col-xl-4 d-flex align-items-stretch">
                                    <div className="icon-box mt-4 mt-xl-0">
                                        ...
                                        <p>If you are experiencing a medical emergency, call for immediate help.</p>
                                    </div>
                                </div>
                                <div className="col-xl-4 d-flex align-items-stretch">
                                    <div className="icon-box mt-4 mt-xl-0">
